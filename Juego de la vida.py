# "Game of Life" Realizado por Brayan Galindez con orientación del canal Dot CSV
#  Bgalinde@unal.edu.co
    ...
    for y in range(0, nxC):
        for x in range(0, nyC):
            ...
            if not pauseExect:
               ...
               # Rule #2 Una célula viva con menos de 2 o más de 3 vecinas vivas,
